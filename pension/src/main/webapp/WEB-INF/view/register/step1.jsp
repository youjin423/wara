...
<form action="step2" method="post">
	<div>
		...
		<제 1 장 총 칙> 제 1 조 (목적)
펜션나라 (이하 "회사"라 함)와 이용 고객(이하 '회원')간에 회사가 제공하는 펜션나라의 서비스(한글명:펜션나라, 이하 서비스)의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.

제 2 조 (이용약관의 효력 및 변경)
(1) 이 약관은 펜션나라 웹사이트(http://www.pensionnara.co.kr 이하 '펜션나라 웹')에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
...
(2) 본 이용약관에 대한 동의는 이용신청 당시 해당 펜션나라 웹의 '동의함' 버튼을 누름으로써 의사표시를 합니다.
...
(3) 펜션나라의 이용자ID는 이용자 본인의 동의하에 NHN이 운영하는 자사 사이트의 회원ID와 연결될 수 있습니다.
...
<제 4 장 서비스의 이용>
제 12 조 (서비스 이용 시간)
(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시중단은 펜션나라 웹을 통해 사전에 공지합니다.
...
<제 5 장 계약 해지 및 이용 제한>
제 18 조 (계약 변경 및 해지)
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 펜션나라 웹 내의 [도움말] 메뉴를 이용해 가입해지를 해야 합니다.
...
<부칙> (시행일) 본 약관은 2007년 1월 28일부터 적용됩니다.
 위의 회원약관에 동의하십니까?
 </textarea>
		<br>
	...
	<div>
		<textarea rows="30" cols="100">
	1. 개인정보 수집/이용에 대한 동의 항목

[수집하는 개인정보의 항목]

첫째, 회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 시 아래와 같은 개인정보를 수집하고 있습니다.
- 필수항목 : 아이디, 이메일주소, 비밀번호, 휴대폰번호
- 선택항목 : 닉네임, 생년월일
둘째, 서비스 이용과정이나 사업처리 과정에서 아래와 같은 정보들이 자동으로 생성되어 수집될 수 있습니다.
- 수집 내용 : IP Address, 쿠키, 방문 일시, 서비스 이용 기록, 불량 이용 기록
셋째, 유료 서비스 이용 시에 결제 등을 위해 불가피하게 신용카드 정보, 핸드폰 및 은행계좌 등의 정보와 결제기록 등의 정보가 수집 될 수 있습니다.
...
가. 회원관리 : 회원제 서비스 이용에 따른 개인식별, 불량회원의 부정 이용방지와 비인가 사용방지, 가입의사 확인, 가입 및 가입횟수 제한
나. 신규서비스 개발 및 마케팅·광고에의 활용 : 신규 서비스개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계

[개인정보의 보유·이용 기간]
회사의 이용자 개인정보의 보유 및 이용기간은 회원 가입 시점부터 발생됩니다. 회원 탈퇴를 요청하거나 개인정보의 수집 및 이용에 대한 동의를 철회하는 경우, 수집 및 이용목적이 달성되거나 보유 및 이용기간이 종료된 경우 해당 개인정보를 지체 없이 파기합니다.
